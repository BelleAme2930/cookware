...
export default function DailySalesWidget({ totalSales, cashSales, accountSales, creditSales }) {
    return (
        <div className="bg-gradient-to-r to-[#2193b0] from-[#5cc2da] p-6 rounded-lg shadow-lg hover:shadow-2xl transition duration-300 ease-in-out transform hover:-translate-y-1">
            <h3 className="text-xl font-bold text-white mb-3 text-left">Daily Sales</h3>
