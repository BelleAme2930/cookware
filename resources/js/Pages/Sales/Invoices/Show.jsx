...
const Invoice = ({ sale }) => {
    return (
        <div className="min-h-screen bg-gray-100 p-4">
            <Head title={`Invoice - Sale #INV-${sale.id}`} />

            <div className="max-w-3xl mx-auto p-6 bg-white shadow-lg rounded-lg">

                <div className="flex justify-between items-center mb-6">
                    <img src="/assets/images/logo.png" alt="Company Logo" className="h-16 w-auto" />
                    <h2 className="text-xl font-bold text-gray-800">Invoice: INV-{sale.id}</h2>
                </div>

                <div className="mb-6">
                    <p className="text-sm text-gray-600">
                        <span className="font-bold">Invoice ID: </span><span>INV-{sale.id}</span>
                    </p>
                    <p className="text-sm text-gray-600">
                ...
                <div className="mt-6 text-right">
                    <p className="text-xl font-bold">Total: {sale.total_price}</p>
                </div>
